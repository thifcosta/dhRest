...
public class MainActivity extends AppCompatActivity implements TadashiTypesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nomeDisplay.setText(userNome);
        mailDisplay.setText(userEmail);


        TadashiTypes tadashi01 = new TadashiTypes();
        tadashi01.setNome("Tadashi Junior");
        tadashi01.setDefinition("Comida pronta em 10 minutos!");
        ...
        tadashi02.setDefinition("Aquele banquete do cozinheiro\nexperiente!");
        ...
        tadashi03.setDefinition("Comidas afrodisíacas pra você\nconquistar a sua gata");
        ...
        tadashi04.setDefinition("Lanches pra você comer na praia,\ndepois de surfar!");
